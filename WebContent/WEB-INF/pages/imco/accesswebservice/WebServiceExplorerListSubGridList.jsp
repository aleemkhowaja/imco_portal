...
<ps:url id="webServiceGuiListSubGridUrl" action="WebServiceExplorerList_loadListSubGridInfo" namespace="/path/WebserviceExplorer" escapeAmp="false">
	...
	<psjg:grid id="${listGridId}"
					caption="" 
					href="%{webServiceGuiListSubGridUrl}" 
					pagerButtons="true" 
					altRows="true"
					dataType="json" 
					filter="false"
					...
					viewrecords="true"
					editinline="true"
					onEditInlineBeforeTopics="onListGridRowSelTopic"
					onGridCompleteTopics ="onListSubGridCompleteFn"   
					editurl=" ">
...
<script type="text/javascript">	
	//	$.struts2_jquery.require("WebServiceExplorerListSubGrid.js" ,null,jQuery.contextPath+"/path/js/proc/webserviceexplorer/");	
		...
		$("#${listGridId}").subscribe("onListSubGridCompleteFn",function(event,data){
