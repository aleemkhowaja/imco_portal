...
<ps:url id="pwsGridParamURL" escapeAmp="false" action="CommonPwsMappingGridAction_loadPwsGridParameters" namespace="/path/imco/pws">	
...
<psjg:grid id="pwsGridParamTbl_Id_${_pageRef}"							
	...
	<psjg:gridColumn id="ARG_TYPE" colType="select" name="apiArgVO.ARG_TYPE" index="ARG_TYPE" 
		...
		editoptions="{value:function(){ 
			return loadCombo('${pageContext.request.contextPath}/path/alert/pws/CommonPwsMappingGridAction_loadArgTypeCombo',
	...
	<psjg:gridColumn id="STATUS" colType="select" name="apiArgVO.STATUS" index="STATUS" 
		...
		loadOnce="true" sortable="false" search="true" align="center" editable="true"
		editoptions="{value:function(){ 
			return loadCombo('${pageContext.request.contextPath}/path/alert/pws/CommonPwsMappingGridAction_loadArgStatusCombo',
