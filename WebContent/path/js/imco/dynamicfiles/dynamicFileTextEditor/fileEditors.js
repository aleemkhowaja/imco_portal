function fileEditor_uploadFile(e){
...
function fileEditor_DbClicked(yesNo)
{
	...
	var dynamicFileStructured = myObject["dynamic_FILE_STRUCTUREVO.DYNAMIC_FILE_STRUCTURE_ID"];
	var fileTypeId = myObject["dynamic_FILE_STRUCTUREVO.FILE_TYPE"];
	var action = jQuery.contextPath+"/path/fileStructure/DynamicFileStructureMaintAction_loadDynamicFileStructure.action";
	var params = {};
	params["dynamicFileStructureCO.dynamic_FILE_STRUCTUREVO.DYNAMIC_FILE_STRUCTURE_ID"] = dynamicFileStructured;
	params["dynamicFileStructureCO.dynamic_FILE_STRUCTUREVO.FILE_TYPE"] = fileTypeId;
	...
	$.post(action, params, function(param)
	{
		...
		$("#textEditor_"+_pageRef).hide();
		var fileType = myObject["dynamic_FILE_STRUCTUREVO.FILE_TYPE"];
