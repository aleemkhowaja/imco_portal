...
String localLang = request.getSession().getAttribute("localLang") != null ? (String)request.getSession().getAttribute("localLang") : com.opensymphony.xwork2.ActionContext.getContext().getLocale().getLanguage() ;
